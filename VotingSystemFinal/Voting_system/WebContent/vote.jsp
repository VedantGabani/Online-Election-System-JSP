						...
						<center>
							<form method="POST" action="VotingServlet">
								...
								<table cellspacing=0 cellpadding="10">
									<tr>
									<c:choose>
										<c:when test="${(user.vote).equalsIgnoreCase('vedant')}">
										<tr>	
											<td></td>
											<td align=left><input type="radio" name="vote" value="vedant"/>Vedant</td>
										</tr>
										<tr>
											<td></td>
											<td align=left><input type="radio" name="vote"	value="smit"/>Smit</td>
										</tr>
										<tr>
											<td></td>
											<td align=left><input type="radio" name="vote" value="pratik" />Pratik</td>
										</tr>
										
										</c:when>
										<c:when test="${(user.vote).equalsIgnoreCase('smit')}">
											<tr>
												<td></td>
												<td align=left><input type="radio" name="vote" value="vedant"/>Vedant</td>
											</tr>
